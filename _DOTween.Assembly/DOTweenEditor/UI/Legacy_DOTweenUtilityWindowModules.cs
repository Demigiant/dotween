...
{
    /// <summary>
    /// Used before v1.2.800 (when DOTween went back to using defines instead of rewriting scripts)
    /// </summary>
    [Obsolete("Use DOTweenUtilityWindowModules instead", true)]
    public static class Legacy_DOTweenUtilityWindowModules
    {
        ...
        static Legacy_DOTweenUtilityWindowModules()
        {
