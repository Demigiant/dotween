...
public class Shortcuts : MonoBehaviour
{
	...
	void Start()
	{
		...
		// Color
		NewTransform().GetComponent<Renderer>().material.DOColor(Color.green, 1).SetLoops(-1, LoopType.Yoyo);
		// Alpha
		NewTransform().GetComponent<Renderer>().material.DOFade(0, 1).SetLoops(-1, LoopType.Yoyo);
	}
